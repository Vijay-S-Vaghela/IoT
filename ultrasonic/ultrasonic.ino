...
String apiKey = "OCHIU11ZEU2AQJZH"; // write your "Write API key"
const char* ssid = "VJ HOME"; // write your "wifi name"
const char* password = "vijayvaghela21"; // write your "wifi password"
